...
cdo -b 64 chname,t2m,ta -timmean -selname,t2m -subc,273.15 Raw_ERA_Dataset.nc ../ta.nc

# Calculate annual amplitude of air temperature:

cdo -b 64 chname,t2m,aa -sub -timmax -selname,t2m Raw_ERA_Dataset.nc -timmin -selname,t2m Raw_ERA_Dataset.nc ../aa.nc

# Calculate annual mean of snow depth:

cdo -b 64 chname,sd,snd -timmean -selname,sd Raw_ERA_Dataset.nc ../snd.nc

# Calculate annual mean of snow density:

cdo -b 64 chname,rsn,rsn -timmean -selname,rsn Raw_ERA_Dataset.nc ../rsn.nc

# Calculate annual max of soil water (summer):

cdo -b 64 chname,swvl1,vwc -timmax -selname,swvl1 Raw_ERA_Dataset.nc ../vwc.nc
